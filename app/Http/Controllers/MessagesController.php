...
class MessagesController extends Controller
{
    public function index()
    {
        ...
        $msgsent = message::all()->where('status', 'Active')->where('scat', 'admin')->where('msgcat', 'admin')->sortBy('created_at', 0, 'desc');
        ...
        $msgsentnot = message::all()->where('status', 'Active')->where('scat', 'admin')->where('msgcat', 'admin')->where('msgstats', 'unread')->sortBy('created_at', 0, 'desc');
        ...
        $admins = Admin::all()->where('status', 'Active')->sortBy('created_at', 0, 'desc');
