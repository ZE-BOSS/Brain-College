	...
	@extends('layouts.admin')
		...
		@section('content')
			<div class="container-fluid dashboard-content">
	            ...
	            <div class="row">
	                <div class="col-xl-8">
	                    <a href="{{url('main_controller_panel/hostels/create')}}" class="btn btn-success">Add New Hostel</a>
		                            ...
		                            <table class="table" id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
		                                ...
		                                <tbody style="position: relative;">
		                                	@foreach($hostels as $hostel)
			                                    <tr>
			                                    	<td></td>
			                                        <td><a href="{{route('hostels.show', $hostel->id)}}">{{$hostel->name}}</a></td>
			                                        ...
			                                        <td>
			                                            ...
			                                            <div class="collapse submenu" id="submenu-{{$hostel->id}}" style="position: absolute; background-color: white; border: 1px solid; border-color: #b8bce0; z-index: 1000;">
					                                        <!-- item-->
				                                            <a href="{{route('hostels.show', $hostel->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-eye"></i> View</a>
				                                            <!-- item-->
				                                            <a href="{{route('hostels.edit', $hostel->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-edit"></i>Edit</a>
				                                            <!-- item-->
				                                    ...
				                                    <div class="modal-dialog" role="document">
				                                        <div class="modal-content">
				                                            ...
				                                            <div class="modal-footer">
				                                                <form id="delete-form-{{ $hostel->id }}" method="post" action="{{ route('hostels.destroy',$hostel->id) }}" style="display: none">
				                                                  {{ csrf_field() }}
				                                                  {{ method_field('DELETE') }}
				                                                </form>
