    ...
    @extends('layouts.admin')
        ...
        @section('content')
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <a href="{{route('hostels.index')}}" class="btn btn-danger"> < Back </a>
                    </div>
                            ...
                            <div class="tab-content" id="myTabContent5">
                                                            ...
                                                            @foreach($session as $sec)
                                                                @foreach($term as $ter)
                                                                    @if($hostel_list->term == $ter->id && $ter->category == 'Open' && $hostel_list->session == $sec->id && $sec->category == 'Open')
                                                                        @include('inc.admin.hostel.lists')
                                                                    @endif
                                                                @endforeach
                                                            @endforeach
                                                        @endforeach
                                ...
                                <div class="tab-pane fade" id="profile-simple" role="tabpanel" aria-labelledby="profile-tab-simple">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><a href="{{route('hostels.edit', $hostel->id)}}"><i class="fas fa-edit"></i> Edit {{$hostel->name}}</a></p>
                                            </div>
                                            <div class="col-md-6">
