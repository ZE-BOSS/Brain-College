                    ...
                    <div class="page-header">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('library.index')}}" class="breadcrumb-link">Library</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('library.index')}}" class="btn-danger" style="padding: 10px;"> < Back</a>
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ route('library.update', $library->id) }}" id="edit-form-{{ $library->id }}" enctype="multipart/form-data" method="post">
                                        @csrf
                                        {{ method_field('PUT') }}
                                        <div class="row">
