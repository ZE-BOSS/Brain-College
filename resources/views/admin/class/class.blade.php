	...
	@extends('layouts.admin')
		...
		@section('content')
			<div class="container-fluid dashboard-content">
	            ...
	            <div class="row">
	                <div class="col-xl-8">
	                    <a href="{{url('main_controller_panel/classes/create')}}" class="btn btn-success">Create New Class</a>
			                                    ...
			                                    <tr>
			                                        ...
			                                        <td>
			                                            ...
			                                            <div class="collapse submenu" id="submenu-{{$clas->id}}" style="position: absolute; background-color: white; border: 1px solid; border-color: #b8bce0; z-index: 1000;">
					                                        <!-- item-->
				                                            <a href="{{route('classes.show', $clas->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-eye"></i> View</a>
				                                            <!-- item-->
				                                            <a href="{{route('classes.edit', $clas->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-edit"></i> Edit</a>
				                                            <!-- item-->
