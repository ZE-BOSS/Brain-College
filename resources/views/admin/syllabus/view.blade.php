    ...
    @extends('layouts.admin')
        ...
        @section('content')
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <a href="{{route('syllabus.index')}}" class="btn btn-danger"> < Back </a>
                    </div>
                            ...
                            <div class="tab-content" id="myTabContent5">
                                        ...
                                        @foreach($classes as $class)
                                            @foreach($subjects as $subject)
                                                @if($subject->id == $syllabus->subjectid && $class->id == $syllabus->classid)
                                                    <p style="font-size: 30px; padding: 20px; text-align: center;">Syllabus For <a href="{{route('subjects.show', $subject->id)}}"> {{$subject->name}}</a>, <a href="{{route('classes.show', $class->id)}}"> {{$class->name}}</a></p>
                                                @endif
                                            @endforeach
                                        @endforeach
                                    @else
                                    ...
                                    @if(count($syll_lists) > 0)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2"><br>
                                                <a href="/main_controller_panel/syllabi/print/{{$id}}" class="btn btn-success" target="_blank">Print</a>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                                <div class="tab-pane fade" id="profile-simple" role="tabpanel" aria-labelledby="profile-tab-simple">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p><a href="{{route('syllabus.edit', $syllabus->id)}}"><i class="fas fa-edit"></i> Edit Syllabus</a></p>
                                            </div>
                                            <div class="col-md-6">
