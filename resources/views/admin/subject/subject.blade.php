	...
	@extends('layouts.admin')
		...
		@section('content')
			<div class="container-fluid dashboard-content">
	            ...
	            <div class="row">
	                <div class="col-xl-8">
	                    <a href="{{url('main_controller_panel/subjects/create')}}" class="btn btn-success">Add New Subject</a>
			                                    ...
			                                    <tr>
			                                        	...
			                                        	@if(count($books) > 0)
			                                        		@foreach($books as $book)
			                                        			@if($book->subject == $subject->id)
			                                        				<a href="{{route('books.show', $book->id)}}">{{$book->name}}</a><br>
			                                        			@else
			                                        ...
			                                        <td>
			                                            ...
			                                            <div class="collapse submenu" id="sub_submenu-{{$subject->id}}" style="position: absolute; background-color: white; border: 1px solid; border-color: #b8bce0; z-index: 1000;">
					                                        <!-- item-->
				                                            <a href="{{route('subjects.show', $subject->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-eye"></i> View</a>
				                                            <!-- item-->
				                                            <a href="{{route('subjects.edit', $subject->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-edit"></i> Edit</a>
				                                            <!-- item-->
