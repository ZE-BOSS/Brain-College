@extends('layouts.admin')
    ...
    @section('content')
        <div class="container-fluid dashboard-content ">
            ...
            <div class="row">
                <div class="col-xl-8">
                    <a href="{{url('main_controller_panel/news/create')}}" class="btn btn-success">Create News</a>
                                    ...
                                    <div class="card card-figure">
                                        ...
                                        <figure class="figure">
                                            ...
                                            <div class="collapse submenu" id="submenu-{{$new->id}}">
                                                ...
                                                <a class="dropdown-item" href="{{route('news.edit', $new->id)}}"><i class="fas fa-edit"></i> &nbspEdit</a>
