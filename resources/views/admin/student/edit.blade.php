                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ route('students.update', $id) }}" class="needs-validation" novalidate="" id="edit-form-{{ $student->id }}" enctype="multipart/form-data" method="post">
                                        @csrf
                                        {{ method_field('PUT') }}
                                        <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <i style="color: red;">If you click on the photo file input, you will have to reupload student's photo</i>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
