@extends('layouts.admin')
    ...
    @section('content')
        <div class="container-fluid dashboard-content ">
            ...
            <div class="row">
                <div class="col-xl-8">
                    <a href="{{url('main_controller_panel/galleries/create')}}" class="btn btn-success">Create New Gallery Media</a>
                                    ...
                                    <div class="card card-figure">
                                        ...
                                        <figure class="figure">
                                            ...
                                            <div class="collapse submenu" id="submenu-{{$gallery->id}}">
                                                <a class="dropdown-item" href="{{route('galleries.edit', $gallery->id)}}"><i class="fas fa-edit"></i> &nbspEdit</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form id="delete-form-{{ $gallery->id }}" method="post" action="{{ route('galleries.destroy',$gallery->id) }}" style="display: none">
                                                  {{ csrf_field() }}
                                                  {{ method_field('DELETE') }}
                                                </form>
