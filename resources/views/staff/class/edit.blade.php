@extends('layouts.staff')
    ...
    @section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('staff_class.index')}}" class="btn-danger" style="padding: 10px;"> < Back</a>
                                    ...
                                    <form action="{{ route('classes.update', $clas->id) }}" id="edit-form-{{ $clas->id }}" enctype="multipart/form-data" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <i style="color: red; font-size: 13px;">NOTE: This input is required, but really useful if you have the same class with multiple name. If not just type in none.</i>
                                                <div class="invalid-feedback">
        ...
        <div class="modal fade" id="exampleModal{{$clas->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;">
