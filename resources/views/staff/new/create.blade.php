                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('staff_news.index')}}" class="btn-danger" style="padding: 10px;"> < Back</a>
                                    <i class="mb-0" style="padding-right: 5px;"></i>
                                    <i class="mb-0" style="font-size: 19px; margin-left: 38%;">Create News</i>
                                </div>
                                <div class="card-body">
                                    @if(count($errors) > 0)
                                    ...
                                    @endif
                                    <form action="{{ route('staff_news.store') }}" enctype="multipart/form-data" method="post">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <hr class="mb-4">
                                        <button class="btn btn-primary btn-lg" type="submit">Add News</button>
                                    </form>
                                </div>
                            </div>
                        </div>
