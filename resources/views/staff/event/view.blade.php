                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="collapse submenu" id="submenu-{{$id}}">
                                            <a class="dropdown-item" href="{{route('staff_event.edit', $id)}}"><i class="fas fa-edit" style="color: gray; font-size: 15px;"></i> &nbspEdit</a>
                                                    ...
                                                    <div class="card card-figure">
                                                        ...
                                                        <figure class="figure">
                                                            ...
                                                            <div class="collapse submenu" id="submenu-{{$sevent->id}}">
                                                                <a class="dropdown-item" href="{{route('staff_event.show', $sevent->id)}}"><i class="fas fa-eye"></i> &nbspView</a>
                                                                <a class="dropdown-item" href="{{route('staff_event.edit', $sevent->id)}}"><i class="fas fa-edit"></i> &nbspEdit</a>
                                                            ...
                                                            <div class="figure-img">
                                                                ...
                                                                @if($sevent->type == 'image' && !empty($sevent->image))
                                                                    ...
                                                                    <div class="figure-action">
                                                                        <a href="{{route('staff_event.show',$sevent->id)}}" class="btn btn-block btn-sm btn-primary">View More</a>
                                                                    </div>
                                                                @elseif($sevent->type == 'video' && !empty($sevent->image))
                                                                    <a href="{{route('staff_event.show',$sevent->id)}}" class="img-link">
                                                            ...
                                                            <figcaption class="figure-caption">
                                                                ...
                                                                <h5 class="figure-title"><a href="{{route('staff_event.show',$event->id)}}">{{$sevent->title}}</a></h5>
                                                                @if(date("Y/m/d") > $sevent->y.'/'.$sevent->m.'/'.$sevent->d)
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form id="delete-form-{{ $sevent->id }}" method="post" action="{{ route('staff_event.destroy',$sevent->id) }}" style="display: none">
                                                                  {{ csrf_field() }}
                                                                  {{ method_field('DELETE') }}
                                                                </form>
        ...
        <div class="modal fade show" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form id="delete-form-{{ $event->id }}" method="post" action="{{ route('staff_event.destroy',$event->id) }}" style="display: none">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}
                        </form>
                        <a href="#" class="btn btn-secondary" data-dismiss="modal">Cancel</a>
