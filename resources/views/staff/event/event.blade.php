@extends('layouts.staff')
    ...
    @section('content')
        <div class="container-fluid dashboard-content ">
            ...
            <div class="row">
                <div class="col-xl-8">
                    <a href="{{url('staff_portal/staff_event/create')}}" class="btn btn-success">Create New Event</a>
                </div>
                                    ...
                                    <div class="card card-figure">
                                        ...
                                        <figure class="figure">
                                            ...
                                            <div class="collapse submenu" id="submenu-{{$event->id}}">
                                                <a class="dropdown-item" href="{{route('staff_event.show', $event->id)}}"><i class="fas fa-eye"></i> &nbspView</a>
                                                <a class="dropdown-item" href="{{route('staff_event.edit', $event->id)}}"><i class="fas fa-edit"></i> &nbspEdit</a>
                                            ...
                                            <div class="figure-img">
                                                ...
                                                @if($event->type == 'image' && !empty($event->image))
                                                    ...
                                                    <div class="figure-action">
                                                        <a href="{{route('staff_event.show',$event->id)}}" class="btn btn-block btn-sm btn-primary">View More</a>
                                                    </div>
                                                @elseif($event->type == 'video' && !empty($event->image))
                                                    <a href="{{route('staff_event.show',$event->id)}}" class="img-link">
