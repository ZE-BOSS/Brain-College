	...
	@extends('layouts.staff')
		...
		@section('content')
			<div class="container-fluid dashboard-content">
	            ...
	            <div class="row">
	                <div class="col-xl-8">
	                    <a href="{{url('staff_portal/staff_syllabus/create')}}" class="btn btn-success">Add New syllabus</a>
	                </div>
			                                    ...
			                                    <tr>
			                                        	...
			                                        	@if(count($subjects) > 0)
			                                        		@foreach($subjects as $subject)
			                                        			@if($subject->id == $syllabus->subjectid)
			                                        				<a href="{{route('staff_syllabus.show', $syllabus->id)}}">{{$subject->name}}</a>
			                                        			@endif
			                                        		@endforeach
			                                        	@else
			                                        ...
			                                        <td>
			                                            ...
			                                            <div class="collapse submenu" id="ssubmenu-{{$syllabus->id}}" style="position: absolute; background-color: white; border: 1px solid; border-color: #b8bce0; z-index: 1000;">
					                                        <!-- item-->
				                                            <a href="{{route('staff_syllabus.show', $syllabus->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-eye"></i> View</a>
				                                            <!-- item-->
				                                            <a href="{{route('staff_syllabus.edit', $syllabus->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-edit"></i>Edit</a>
				                                            <!-- item-->
