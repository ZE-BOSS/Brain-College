    ...
    @extends('layouts.staff')
        ...
        @section('content')
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <a href="{{route('staff_student.index')}}" class="btn btn-danger"> < Back </a>
                    </div>
                                                                    ...
                                                                    @if($sec->category == 'Open')
                                                                        @foreach($class as $cls)
                                                                            @if($acc->classid == $cls->id && $acc->session == $sec->id)
                                                                                <a href="{{route('staff_class.show', $cls->id)}}"><h6 class="metric-value" style="color: green;">{{$cls->name}}</h6></a>
                                                                            @else
                                ...
                                @if(!empty($allocate) && $allocate->book == Auth::guard('staff')->user()->id)
                                    <div class="tab-pane fade" id="profile-simple" role="tabpanel" aria-labelledby="profile-tab-simple">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p><a href="{{route('staff_student.edit', $student->id)}}"><i class="fas fa-edit"></i> Edit {{$student->firstname}} Profile</a></p>
                                                </div>
                                                <div class="col-md-6">
                                                        ...
                                                        <tr>
                                                                ...
                                                                @if(count($class) > 0)
                                                                    @foreach($class as $clas)
                                                                        @if($res->classid == $clas->id && $res->studentid == $student->id)
                                                                            <a href="{{url('/staff_portal/staff_result/result/'.$res->id)}}" target="_blank">{{$clas->name}}</a>
                                                                        @endif
                                                                    @endforeach
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="collapse submenu" id="submenu-{{$res->id}}" style="position: absolute; background-color: white; border: 1px solid; border-color: #b8bce0; z-index: 1000;">
                                                                    <!-- item-->
                                                                    <a href="{{url('/staff_portal/staff_result/result/'.$res->id)}}" class="dropdown-item" style="color: #71748d;"><i class="fas fa-eye"></i> View</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
