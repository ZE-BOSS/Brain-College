                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('staff_staff.index')}}" class="btn-danger" style="padding: 10px;"> < Back</a>
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{ route('staff_staff.update', $id) }}" class="needs-validation" novalidate="" id="edit-form-{{ $staff->id }}" enctype="multipart/form-data" method="post">
                                        @csrf
                                        {{ method_field('PUT') }}
                                        <div class="row">
