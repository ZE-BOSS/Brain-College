                    ...
                    <div class="col-xl-8">
                        <?php 
                            ...
                            if(!empty($allocate) && $allocate->staff == Auth::guard('staff')->user()->id){
                                echo '<a href="'.route('staff_staff.index').'" class="btn btn-danger"> < Back </a>';
                            }
                        ?>
                    </div>
                                            ...
                                            <div class="col-xl-6 col-lg-4 col-md-6 col-sm-12 col-12">
                                                ...
                                                <div class="metric">
                                                    ...
                                                    @if($staff->status == 'Active')
                                                        <h6 class="metric-value" style="color: green;">Active</h6>
                                                    @else
                                                        <h6 class="metric-value" style="color: red;">Inactive</h6>
                                                    @endif
                                                </div>
                                                <!-- /.metric -->
                                            </div>
