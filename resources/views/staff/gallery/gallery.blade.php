@extends('layouts.staff')
    ...
    @section('content')
        <div class="container-fluid dashboard-content ">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Gallery</h2>
                        <br><br>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-8">
                    <a href="{{url('staff_portal/staff_gallery/create')}}" class="btn btn-success">Create New Gallery Media</a>
                    ...
                    <div class="row">
                        @if(count($galleries) > 0)
                            @foreach($galleries as $gallery)
                                    ...
                                    <div class="card card-figure">
                                        ...
                                        <figure class="figure">
                                            <div class="ellipsis row">
                                                ...
                                                <div class="col-md-2">
                                                    <i class="fas fa-list linka" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-{{$gallery->id}}" aria-controls="submenu-{{$gallery->id}}"></i>
                                                </div>
                                            </div>
                                            <div class="collapse submenu" id="submenu-{{$gallery->id}}">
                                                <a class="dropdown-item" href="{{route('staff_gallery.edit', $gallery->id)}}"><i class="fas fa-edit"></i> &nbspEdit</a>
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal{{$gallery->id}}"><i class=" fas fa-trash-alt"></i> &nbspDelete</a>
                                            </div>
                                            <!-- .figure-img -->
                                            <div class="figure-img">
                                                ...
                                                @if($gallery->type == 'image' && !empty($gallery->image))
                                                    <div class="figure-action">
                                                        <a href="#" data-toggle="modal" data-target="#showModal{{$gallery->id}}" class="btn btn-block btn-sm btn-primary">View Photo</a>
                                                    </div>
                                                @elseif($gallery->type == 'video' && !empty($gallery->image))
                                                    <a href="#" data-toggle="modal" data-target="#showModal{{$gallery->id}}" class="img-link">
                                ...
                                <div class="modal fade show" id="exampleModal{{$gallery->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form id="delete-form-{{ $gallery->id }}" method="post" action="{{ route('staff_gallery.destroy',$gallery->id) }}" style="display: none">
                                                  {{ csrf_field() }}
                                                  {{ method_field('DELETE') }}
                                                </form>
                                                <a href="#" class="btn btn-secondary" data-dismiss="modal">Cancel</a>
                                                <a href="#" onclick="document.getElementById('delete-form-{{ $gallery->id }}').submit();" class="btn btn-primary">Confirm</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade show" id="showModal{{$gallery->id}}" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" style="display: none;">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
    ...
    @endsection
    <!-- <div class="modal fade show" id="showModal" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" style="display: none;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><a href="#">hi</a></h5>
                    <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </a>
                </div>
