            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Edit Gallery Media</h2>
                        <br><br>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="{{route('staff_gallery.index')}}" class="btn-danger" style="padding: 10px;"> < Back</a>
                                    <i class="mb-0" style="padding-right: 5px;"></i>
                                    <i class="mb-0" style="font-size: 19px; margin-left: 38%;">Edit Gallery</i>
                                </div>
                                <div class="card-body">
                                    @if(count($errors) > 0)
                                    ...
                                    @endif
                                    <form action="{{ route('staff_gallery.update', $gallery->id) }}" enctype="multipart/form-data" method="post">
                                        @csrf
                                        {{method_field('PUT')}}
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="firstName">Title</label>
                                                <input type="text" class="form-control" name="title" placeholder="Title" value="{{$gallery->title}}" required="">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="custom-select d-block w-100" name="category" required="">
                                                    <option value="{{$gallery->category}}" selected="selected">{{$gallery->category}}</option>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-group">
                                                <label>Details</label>
                                                <textarea class="form-control" name="details">{{$gallery->details}}</textarea>
                                            </div>
                                        </div>
                                        <hr class="mb-4">
                                        ...
                                        @endif
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" style="border-color: blue;" value="{{$gallery->image}}" placeholder="Choose Image">
                                            </div>
                                        </div>
                                        @if($gallery->type == 'video')
                                        ...
                                        @endif
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" style="border-color: blue;" value="{{$gallery->video}}" placeholder="Choose Video">
                                            </div>
                                        </div>
                                        <hr class="mb-4">
                                        <button class="btn btn-primary btn-lg" type="submit">Update gallery</button>
                                    </form>
                                </div>
                            </div>
                        </div>
