    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#topics").on('keyup', function(e){
                ...
                $.ajax({
                    type:'GET',
                    url: '/main_controller_panel/syllabi/getlist/set/{{$id}}',
                    data: {number:number},
                    success: function(response){                    
                        //alert(number+' success');
                        $('#gettopic').load('/main_controller_panel/syllabi/getlist/get/{{$id}}');
                    },
            ...
            @foreach($syll_lists as $syll_list)
                $(document).ready(function(){
                    $("#remove_syll{{$i}}").on('click', function(e){
                        ...
                        $.ajax({
                            type:'GET',
                            url: '/main_controller_panel/syllabi/removelist/remove/{{$id}}',
                            success: function(response){                    
                                //alert(number+' success');
                                $('#reload').load('/main_controller_panel/syllabus/{{$id}}/edit');
                            },
                            error: function(response){
                                //alert(number+' error');
                            }
