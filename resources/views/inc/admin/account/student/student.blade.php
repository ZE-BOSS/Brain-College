								                                ...
								                                <div id="accordion{{$pay->id}}s{{$student->id}}">
								                                    <div class="card bg-success">
								                                        <div class="card-header" id="headingTen">
								                                            <h5 class="mb-0">
								                                               <button class="btn btn-link text-white collapsed" data-toggle="collapse" data-target="#collapse{{$pay->id}}s{{$student->id}}" aria-expanded="false" aria-controls="collapse{{$pay->id}}s{{$student->id}}">
