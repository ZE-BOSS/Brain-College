									                                ...
									                                <div id="staff_accordion{{$payment->id}}">
									                                    <div class="card bg-success">
									                                        <div class="card-header" id="staff_headingTen{{$payment->id}}">
									                                            <h5 class="mb-0">
									                                               <button class="btn btn-link text-white collapsed" data-toggle="collapse" data-target="#staff_collapseTen{{$payment->id}}" aria-expanded="false" aria-controls="staff_collapseTen{{$payment->id}}">
